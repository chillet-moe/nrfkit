...
| Combined LM20 consumer prerequisites | Complete for current USB/SDC/Timeslot/RRAM lifecycle boundary | C++23 source-tree, installed `find_package`, and independent clean downstream builds PASS offline | SDC/MPSL plus USB control/bulk/HID, 20 reconnects, settings persistence, and long-running fault-state checks PASS | M8 technical gates PASS; 0.1.0-rc.2 prepared |

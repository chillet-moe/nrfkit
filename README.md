...
The latest review-image Timeslot retry gate has an unresolved regression despite passing bidirectional air and BLE coexistence checks. Historical retry/soak results do not validate this image; see the review regression in [`docs/provenance/m7-radio-evidence.md`](docs/provenance/m7-radio-evidence.md).
